...
public:
    GolombBitStreamWriter(BlockWriter& block_writer, size_t const& b)
        : Super(block_writer),
          b_(b),
    ...
    GolombBitStreamWriter(GolombBitStreamWriter const&) = delete;
    //! non-copyable: delete assignment operator
    GolombBitStreamWriter& operator=(GolombBitStreamWriter const&) = delete;
     ...
     */
    void PutGolomb(size_t const& value) {
    ...
    void Put(size_t value) { PutGolomb(value); }
...
public:
    GolombBitStreamReader(BlockReader& block_reader, size_t const& b)
        : Super(block_reader),
          b_(b),
          log2b_(tlx::integer_log2_ceil(b_)), // helper var for Golomb in
          max_little_value_((((size_t)1) << log2b_) - b_) {}
    ...
    //! non-copyable: delete copy-constructor
    GolombBitStreamReader(GolombBitStreamReader const&) = delete;
    //! non-copyable: delete assignment operator
    GolombBitStreamReader& operator=(GolombBitStreamReader const&) = delete;
    //! move-constructor: default
    ...
    size_t Next() {
        static_assert(std::is_same<size_t, Type2>::value, "Invalid Next() call");
        return GetGolomb();
    }
